...
service / on new http:Listener(8081) {
    ...
    resource function get .() returns http:Response {
        string html = "<html><body><h1>CloudOptimizer Pro</h1><p>Use /ai-suggestions for AI cost recommendations.</p><p>Use /report for cost reports.</p><p>Use /resources to view all resources.</p></body></html>";
