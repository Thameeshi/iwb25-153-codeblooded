...
<style>
    ...
    header { background: #0077cc; color: white; padding: 1rem 2rem; }
    h1 { margin: 0; }
    main { padding: 2rem; }
...
<main>
<p>Welcome to CloudOptimizer Pro. Use the following endpoints for demo:</p>
<div class="endpoints">
    <div class="endpoint"><a href="/report">/report</a> - Generate cloud cost report</div>
    <div class="endpoint"><a href="/ai-suggestions">/ai-suggestions</a> - Get AI suggestions</div>
    <div class="endpoint"><a href="/resources">/resources</a> - View all cloud resources</div>
</div>
</main>
</body>
</html>`;
    ...
    resource function get ai-suggestions() returns json {
        ...
        foreach CloudResource r in resources {
            ...
            suggestionsJson.push(<json>rec);
        }
        return { status: "success", timestamp: time:utcToString(time:utcNow()), suggestions: suggestionsJson };
    }

    // All resources endpoint
    resource function get resources() returns json {
        // Convert CloudResource[] to JSON
        json resourcesJson = [];
        foreach CloudResource r in resources {
            resourcesJson.push(<json>r);
        }
        return { status: "success", timestamp: time:utcToString(time:utcNow()), resources: resourcesJson };
    }
