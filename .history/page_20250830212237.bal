...
<body>
    ...
    <script>
        ...
        function displayHealthScore(health) {
            ...
            statsElement.innerHTML = '<div class="stat-item"><div class="stat-value">$' + Math.round(health.totalMonthlyCost) + '</div><div class="stat-label">Monthly Cost</div></div><div class="stat-item"><div class="stat-value">$' + Math.round(health.projectedSavings) + '</div><div class="stat-label">Projected Savings</div></div><div class="stat-item"><div class="stat-value">' + health.activeAnomalies.length + '</div><div class="stat-label">Active Anomalies</div></div>';